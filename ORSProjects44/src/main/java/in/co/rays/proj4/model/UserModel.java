...
////		Connection conn = null;
////		int pk = 0;
////		UserBean existLogin=findByLogin(bean.getLogin());
////		if(existLogin!=null) {
...
////		Connection conn = null;
////		UserBean existLogin=findByLogin(bean.getLogin());
////		if(existLogin!=null && existLogin.getId()!=bean.getId()) {
////			throw new DuplicateRecordException("User Login already exist");
////		}
////		try {
////			conn = JDBCDataSource.getConnection();
...
////				conn.rollback();
////			} catch (Exception e2) {
////				throw new ApplicationException("Excception : Delete rollback Exceeption" + e2.getMessage());
////			}
...
////	}
////
////	public List search(UserBean bean, int pageSize,int pageNo) throws ApplicationException {
////		Connection conn = null;
